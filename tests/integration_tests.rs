...
fn integration_test_greeting_functionality() {
    ...
    assert_eq!(greeting, "Hello Integration (from gignsky-dot-com)!");
...
fn integration_test_verbose_mode() {
    ...
    assert_eq!(greeting, "Hello world (from gignsky-dot-com)!");
}
...
fn integration_test_edge_cases() {
    ...
    assert_eq!(greeting, "Hello  (from gignsky-dot-com)!");
